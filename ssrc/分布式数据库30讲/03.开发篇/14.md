...
![](./httpsstatic001geekbangorgresourceimageea15eafcd1bd0c76c600f576b4a364bf7f15.png "引自Manos Athanassoulis et al.(2016)")
...
![](./httpsstatic001geekbangorgresourceimage6bc86bd6149970b0b760bf61a80fea54ffc8.jpg)
...
![](./httpsstatic001geekbangorgresourceimage60466069eba71bb31754e85940d34526ae46.jpg)
...
![](./httpsstatic001geekbangorgresourceimage213921dc63cef862c71f5614445cb6477839.png "引自Fay Chang et al.(2008)")
...
![](./httpsstatic001geekbangorgresourceimage718e71ae4696ce4d5cbbfedfc6f5d9f0518e.jpg)
...
![](./httpsstatic001geekbangorgresourceimage40ac404015015046166f426ab3f159864bac.jpg)
...
![](./httpsstatic001geekbangorgresourceimagea795a7c9c1ca7723cfaa180461c1b3a8fd95.jpg)

3.  随着L1层数据量的增多，SSTable可能会重新划分边界，目的是保证数据相对均衡的存储。

![](./httpsstatic001geekbangorgresourceimagef6d6f65536e12e95565ebe36c1596c53f9d6.jpg)
...
![](./httpsstatic001geekbangorgresourceimage8c508c891780dd19146d4454a6636c052c50.jpg)
...
![](./httpsstatic001geekbangorgresourceimage199f19a017c90e3cb51c59a96f54563f019f.jpg)
...
![](./httpsstatic001geekbangorgresourceimaged0a9d0eda0529ce4c9796f777c95d46914a9.png "引自Lanyue Lu et al.(2016)")
...
CockroachDB采用Go作为编程语言，而RocksDB是由C加加编写的。所以CockroachDB要面临Go到C的之间的调用障碍。测试表明，每一次对RocksDB的调用都要额外付出70纳秒的延迟。这个数字虽然看上去并不大，但是由于K/V操作非常频繁，总体成本仍然很可观。CockroachDB也通过一些设计来降低延迟，比如将多次K/V操作合并成一次对RocksDB的操作，但是这一方面带来设计的复杂性，另外也无法从根本上解决问题。

值得一提的是，TiDB也使用了Go语言作为主力开发语言，同样面临了这个问题。TiDB最终是在底层存储TiVK放弃Go而选择Rust的，部分原因就是Rust与C加加之间的调用成本要低得多。
...
![](./httpsstatic001geekbangorgresourceimage5b325bbd48e644e90fda6ce91a0360e7e332.jpg)
